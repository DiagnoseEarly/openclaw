...
Store it in your `openclawd.json` configuration file. This is the recommended method.
...
OpenClaw will securely provide this key to the skill. As an alternative for local testing, you can set the `PIPEDRIVE_API_TOKEN` environment variable directly.
